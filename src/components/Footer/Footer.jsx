      ...
      <footer id="footer">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="footer-links">
                ...
                <ul>
                  <li>
                    <i className="bx bx-chevron-right"></i>{" "}
                    <a href="#">Family-Friendly Dining</a>
                  </li>
                  <li>
                    <i className="bx bx-chevron-right"></i>{" "}
              ...
              >
                ...
                <p>
                Get ready to feast on the best BBQ in town! Sign up for our newsletter for exclusive deals, menu updates, and mouth-watering recipes.
                </p>
                <form>
        ...
        <div className="container mx-auto px-4">
          <div className="copyright text-center mt-8">
            &copy; {date.getFullYear()} <strong><span>BBQ House</span></strong>. All Rights
            Reserved
          </div>
        </div>
      </footer>
